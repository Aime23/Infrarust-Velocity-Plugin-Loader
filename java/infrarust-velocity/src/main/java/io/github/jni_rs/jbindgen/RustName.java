...
/**
 * Annotation to override the generated Rust name for Java classes, methods, fields, and
 * constructors.
 *
 * <p>
 * This annotation allows you to customize the Rust identifier names generated by jbindgen, which is
 * useful when:
 * <ul>
 ...
 * <li>For constructors: Typically "new" or "new_*" (e.g., "new_with_options")</li>
 * </ul>
 *
 * <p>
 * The annotation value must be a valid Rust identifier. The jbindgen tool will use this exact name
 * in the generated bindings without any transformation.
 *
 * @since 0.1.0
 */
